# -------------------------------------------
# audio_visualizer.py
# Helper functions for Audio_Visualizer.ipynb
# Emily Brown 8/25/2021
# -------------------------------------------
...
# ---
# find_songs()
# Given a path to a folder containing audio files,
# builds lists of audio files for the notebook to use.
#
# Args: path - str of pathname to search.
# 
# Returns: song_waves - a list of numpy arrays containing
#          the waveform of audio files, loaded using Librosa.
#          song_names - a list containing the names of the audio files,
#          with the file extensions trimmed.
#          song_box   - a list of tuples containing the trimmed audio file
#          names and their index number - used for building interface drop-down box.
#
# Note: Currently doesn't check to make sure files are actually audio files - assumes
#       the folder has been prepared ahead of time.
...
# ---
# visualize()
# Creates user interface for running visualizations.
#
# Args: song_waves - a list of numpy arrays containing audio waveforms.
#       song_names - a list containing trimmed audio file names.
#       song_box   - a list of tuples containing the trimmed audio file
#       names and their index number - used for building interface drop-down box. 

def visualize(song_waves, song_names, song_box):
...
# ---
# option_interact()
# Interactive function called by visualize() public function. Calls select_options()
# according to interactive specifications and sets appropriate visualization title(s).
#
# Args: song_waves - a list of numpy arrays containing audio waveforms.
#       song_names - a list containing trimmed audio file names.
#       song1 - index of the first song to plot.
#       song2 - index of the second song to plot.
#       plot1 - which type of plot (wave, spectrum, spetrogram) to plot for first song.
#       plot2 - which type of plot to plot for second song.
#       length1 - which length (full, 30 seconds, 5 seconds, or 50 milliseconds) to use for first song plot.
#       length2 - which length to use for second song plot.
...
# ---
# select_options()
# Calls the appropriate plotting functions for a song given a set of options.
#
# Args: song_waves - a list of numpy arrays containing audio waveforms.
#       Song       - index of the song to plot.
#       Plot       - which type of plot (wave, spectrum, spetrogram) to plot
#       Length     - which length (full, 30 seconds, 5 seconds, or 50 milliseconds) to use
...
# ---
# plot_wave()
# Draws waveform plot using librosa.
#
# Args: wave - numpy array of audio waveform.
...
#
# Args: wave - numpy array of audio waveform.
#       sr   - sample rate of the audio waveform.
...
# ---
# plot_spectrogram()
# Draws spectrogram plot using librosa. 
#
# Args: wave - numpy array of audio waveform.
